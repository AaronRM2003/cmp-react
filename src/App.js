        ...
        <BrowserRouter >
            ...
            {!isDesktop?<>
                <p style={{position:'absolute'}} >
                 <img style={{width:'150px',objectFit:'contain'}} src={img}></img> </p><p style={{marginLeft:'10%',marginTop:'15%',width:'100%',marginBottom:'5%'}}> <div className="h"><div onClick={()=>setShow(true)}> <Link className="link" to="/pages/Form"  >Login</Link>      <Link className="link" to="/pages/Contact" >Contact</Link>   <Link className="link" to="/pages/About">About</Link>
                    </div> </div></p>
     
                    </>:<>  
                 <img style={{width:'150px',objectFit:'cover'}} src={img}></img><div style={{marginLeft:'10%',marginTop:'5%',width:'100%',marginBottom:'0%'}}> <div className="h" style={{marginTop:'0%',marginBottom:'0%'}}><div onClick={()=>setShow(true)}> <Link className="link" to="/pages/Form"  >Login</Link>      <Link className="link" to="/pages/Contact" >Contact</Link>   <Link className="link" to="/pages/About">About</Link>
                    </div> </div></div></>}
